    ...
    from-black to-gray-800 p-4 text-white'>
        ...
        mx-auto h-full'>
            ...
            <div className='flex justify-center items-center'>
                <form action="https://getform.io/f/492da87f-73be-42e6-b0de-0846207f2db7"
                method='POST' className='flex flex-col w-full md:w-1/2'>
                    ...
                    placeholder='Enter your message'className='p-2 
                    ...
                    rounded-b-xl hover:scale-110 duration-300'>Contact Me</button>
                </form>
            </div>
        </div>
    </div>
